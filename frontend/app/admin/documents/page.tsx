                            ...
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className={`p-8 rounded-t-2xl mb-8 flex items-center justify-between border-b-4 bg-gradient-to-r from-blue-600 to-purple-600 border-gray-800 text-white print:bg-white print:text-black print:border-black print:p-6 print:rounded-none`}>
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            <h1 className="text-3xl font-black uppercase tracking-tight">{profile?.schoolName || 'Enovazone Acadimeca'}</h1>
                        ...
                        <div className="p-8 print:p-12 print:break-before-page mt-8 border-t-4 border-dashed border-gray-300 print:border-0">
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className="mt-8 text-center text-green-600 font-bold text-lg font-serif">
                                    Signed by Enovazone Acadimeca Hay Elmoukawama Ouarzazate
                                </div>
                            </div>
                        </div>
                    </div>
